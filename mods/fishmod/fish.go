...
func (m *FishMod) Passives() []*meido.ModPassive {
	return []*meido.ModPassive{}
}

// Commands returns the mod commands.
func (m *FishMod) Commands() map[string]*meido.ModCommand {
	return m.commands
}

// AllowedTypes returns the allowed MessageTypes.
func (m *FishMod) AllowedTypes() meido.MessageType {
...
func (m *FishMod) Hook(b *meido.Bot) error {
	err := m.Load()
	if err != nil {
		return err
	}
...
func (m *FishMod) RegisterCommand(cmd *meido.ModCommand) {
	m.Lock()
	defer m.Unlock()
...
func NewFishCommand(m *FishMod) *meido.ModCommand {
...
func (m *FishMod) fishCommand(msg *meido.DiscordMessage) {
	fp := pickFish()
...
func NewAquariumCommand(m *FishMod) *meido.ModCommand {
	return &meido.ModCommand{
		Mod:           m,
		Name:          "aquarium",
...
func (m *FishMod) aquariumCommand(msg *meido.DiscordMessage) {

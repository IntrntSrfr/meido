...
func TestDiscordMessage_Type(t *testing.T) {
	msg := &DiscordMessage{MessageType: MessageTypeCreate}
	if got := msg.Type(); got != MessageTypeCreate {
		t.Errorf("DiscordMessage.Type() = %v, want %v", got, MessageTypeCreate)
	}
}

func TestDiscordMessage_Args(t *testing.T) {
	msg := &DiscordMessage{Message: &discordgo.Message{Content: "I am a message"}}
...
func TestDiscordMessage_IsDM(t *testing.T) {
	msg := &DiscordMessage{Message: &discordgo.Message{GuildID: ""}}
	if ok := msg.IsDM(); !ok {
		t.Errorf("DiscordMessage.IsDM() = %v, want %v", ok, true)
	}

	msg = &DiscordMessage{Message: &discordgo.Message{GuildID: "12341234"}}
	if ok := msg.IsDM(); ok {
...
func TestDiscordMessage_IsBot(t *testing.T) {
	msg := &DiscordMessage{Message: &discordgo.Message{Author: &discordgo.User{Bot: false}}}
	if ok := msg.IsBot(); ok {
		t.Errorf("DiscordMessage.IsBot() = %v, want %v", ok, false)
	}
	msg = &DiscordMessage{Message: &discordgo.Message{Author: &discordgo.User{Bot: true}}}
	if ok := msg.IsBot(); !ok {
...
func TestDiscordMessage_Author(t *testing.T) {
	...
	msg := &DiscordMessage{Message: &discordgo.Message{Author: author}}
...
func TestDiscordMessage_Member(t *testing.T) {
	...
	msg := &DiscordMessage{Message: &discordgo.Message{Member: member}}
...
func TestDiscordMessage_ID(t *testing.T) {
	id := "1234"
	msg := &DiscordMessage{Message: &discordgo.Message{ID: id}}
...
func TestDiscordMessage_AuthorID(t *testing.T) {
	id := "1234"
	msg := &DiscordMessage{Message: &discordgo.Message{Author: &discordgo.User{ID: id}}}
	if got := msg.AuthorID(); got != id {
		t.Errorf("DiscordMessage.AuthorID() = %v, want %v", got, id)
	}

	id = ""
	msg = &DiscordMessage{Message: &discordgo.Message{}}
	if got := msg.AuthorID(); got != id {
		t.Errorf("DiscordMessage.AuthorID() = %v, want %v", got, id)
	}
}
...
func TestDiscordMessage_GuildID(t *testing.T) {
	id := "1234"
	msg := &DiscordMessage{Message: &discordgo.Message{GuildID: id}}
...
func TestDiscordMessage_ChannelID(t *testing.T) {
	id := "1234"
	msg := &DiscordMessage{Message: &discordgo.Message{ChannelID: id}}
...
func TestDiscordMessage_Mentions(t *testing.T) {
	...
	msg := &DiscordMessage{Message: &discordgo.Message{Mentions: mentions}}
...
func TestDiscordMessage_MentionRoles(t *testing.T) {
	...
	msg := &DiscordMessage{Message: &discordgo.Message{MentionRoles: mentions}}
...
func TestDiscordMessage_Attachments(t *testing.T) {
	...
	msg := &DiscordMessage{Message: &discordgo.Message{Attachments: attachments}}
